...
class ImageClassifier(object):
    ...
    def _create_optimizer(self, name, model_params, lr):
        optim_dict = {"SGD":torch.optim.SGD(model_params.parameters(), lr,weight_decay=1e-5, momentum=0.9, nesterov=True),
                      ...
                      "SGDAGC": SGD_AGC(model_params.parameters(), lr=lr, momentum=0.9, nesterov=True, clipping=0.16, weight_decay=1e-5)
        }
    ...
    def _create_criterion(self, name):
        loss_dict = {"CCE": nn.CrossEntropyLoss().cuda(),#weight=torch.tensor([0.5,0.5,0.9])
    ...
    def _train_or_eval(self, loader, train):
        ...
        for idx, data in enumerate(loader):
            ...
            if train:
                ...
                x = torchvision.transforms.RandomResizedCrop(self.resolution, scale=(0.5, 1.0))(x)
